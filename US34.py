...
for line1 in x [19:21]:
	if '2 DATE' in line1:
		...
		print 'Was born in the year:', hos2
...
hos5= None
pos5=None		
for line1 in x [33:35]:
	if '2 DATE' in line1:
		pos5 = line1.find('E')
		hos5= line1[pos5+8:18]
		print 'Was born in the year:', hos5


hos6= None
pos6=None		
for line1 in x [192:194]:
	if '2 DATE' in line1:
		pos6 = line1.find('E')
		hos6= line1[pos6+8:18]
		print 'They got married in the year:', hos6
		
		print 'His age at marriage was:', int(hos6)- int(hos2)
		print 'Her age at marriage was:', int(hos6)- int(hos5)
